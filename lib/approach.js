...
const usage = { angle: [], device: [], opener: [], close: [], accent: [], theme: [] };
for (const k of Object.keys(usage)) {
  usage[k] = new Array(k === 'accent' ? ACCENTS.length : k === 'theme' ? THEMES.length : AXES[k].length).fill(0);
}
...
module.exports = { AXES, ACCENTS, THEMES, approachFor };
